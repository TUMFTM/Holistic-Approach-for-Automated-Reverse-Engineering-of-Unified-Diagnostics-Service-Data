...
class ReadDataByIdentifier(BaseService):
    ...
    def make_request(cls, didlist: Union[int, List[int]]) -> Request:
        ...
        #     codec = make_did_codec_from_config(
        #         didconfig[did]
    ...
    def interpret_response(
        ...
        if response.data is None:
            print(InvalidResponseException(response, "No data in response"))
        ...
        offset = 0
        # print("Länge response.data: ", len(response.data))
        while True:
            ...
            if (
                did == 0 and did and tolerate_zero_padding
            ...
            response.service_data.values[did] = subpayload
            break
